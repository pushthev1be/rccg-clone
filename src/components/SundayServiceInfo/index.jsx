  ...
  return (
    ...
    >
      <div className="flex flex-col items-start gap-2 self-stretch">
        <Text size="textlg" as="p" className="text-[24px] font-medium !text-gray-900">
          {serviceTitle}
        </Text>
      ...
      <div className="flex flex-col gap-3 self-stretch">
        <div className="flex items-center gap-2">
          <Img src="img_navigation_house_03_gray_900_02.svg" width={20} height={20} alt="Image" className="h-[20px]" />
        ...
        <div className="flex items-center gap-2">
          <Img src="img_search.svg" width={20} height={20} alt="10th January" className="h-[20px]" />
          <Text as="p" className="text-[16px] font-normal !text-gray-900_02">
            {serviceDateText}
          </Text>
        </div>
